...
class MSR_VTT_ClipFolderDataset(torch.utils.data.Dataset):
    def __init__(self, root, split='train', **kwargs):
        super(MSR_VTT_ClipFolderDataset, self).__init__()
...
@DATASETS.register_module()
class MSR_VTT_ClipFolderDatasetMultiFrames(MSR_VTT_ClipFolderDataset):
    def __init__(self, root, transform=None, split='train', sample_num=0):
        super(MSR_VTT_ClipFolderDatasetMultiFrames, self).__init__(root, split)
...
@DATASETS.register_module()
class MSR_VTT_ClipFolderDatasetOrderTSN(MSR_VTT_ClipFolderDataset):
    def __init__(self, root, transform=None, split='train_list'):
        super(MSR_VTT_ClipFolderDatasetOrderTSN, self).__init__(root, split)
        self.transform = transform
        assert self.transform is not None
